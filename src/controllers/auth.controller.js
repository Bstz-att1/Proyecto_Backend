...
// ====================================================
/**
 * Procesa autenticación por documento y contraseña.
 * Retorna tokens de sesión y perfil base del usuario con permisos asociados.
 */
export const loginJWT = catchAsync(async (req, res, next) => {
    const { document, password } = req.body;

    // Valida datos mínimos de autenticación.
    ...
    // Busca el usuario por documento para validación de credenciales.
    ...
    // Consulta permisos vigentes del usuario para informar capacidades del sistema.
    const permissions = await RoleModel.getPermissionsByUserId(user.id);
    ...
    // Genera refresh token para renovación controlada de sesión.
    ...
    // Persiste refresh token para control de revocación.
    await UserModel.updateRefreshToken(user.id, refreshToken);

    // Retorna datos de sesión, usuario autenticado y permisos asignados.
...
// ====================================================
/**
 * Renueva tokens de sesión a partir de un refresh token válido y no revocado.
 */
...
// ====================================================
/**
 * Cierra la sesión revocando refresh token e invalidando access tokens previos.
 */
