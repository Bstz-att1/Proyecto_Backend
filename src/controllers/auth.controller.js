...
export const loginJWT = catchAsync(async (req, res, next) => {
  ...
  const user = await UsersModel.findByDocument(document);
...
export const refreshJWT = catchAsync(async (req, res, next) => {
  ...
  await UsersModel.updateRefreshToken(user.id, newRefreshToken);
...
export const logout = catchAsync(async (req, res, next) => {
  ...
  if (user) {
    await UsersModel.revokeRefreshToken(user.id);
  }
